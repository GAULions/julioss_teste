...
<html lang="pt-BR">
    <head>
        ...
        <script src="js/passageiro.js" type="text/javascript"></script>
    </head>
    ...
    <body>
        ...
        <div class="container">
            ...
            <div id="passageiro" class="col-sm-12 col-md-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <span class="fa fa-building fa-fw"></span><span class=""> Passageiros</span>
                        <button class="pull-right btn btn-success btn-xs entrar_chat w3-padding-4" data-toggle="modal" data-target="#cad_pass">
    ...
    <div id="cad_pass" class="modal fade" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form name="passageiro" id="form_cadastrar_passageiro" enctype="multipart/form-data">
                    <div class="modal-header">
                        <span>Cadastrar Passageiro</span>
                        <span class="close pull-right" data-dismiss="modal" data-target="#cad_pass">×</span>
                    </div>
